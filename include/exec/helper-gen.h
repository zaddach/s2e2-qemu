...
{                                                                       \
  tcg_gen_callN(&tcg_ctx, (void *) HELPER(name),                        \
	dh_retvar(ret), 0, NULL);                                           \
}
